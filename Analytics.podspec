...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/blackcolt/Analytics'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'blackcolt' => 'idan.magled@naturalint.com' }
  s.source           = { :git => 'https://github.com/blackcolt/Analytics.git', :tag => s.version.to_s }
